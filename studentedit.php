...
//query database
	$query = "SELECT * FROM students WHERE idPelajar = '$idstud'";
...
<form action="studentedit2.php" method="POST">	
		...
		<input type="text"  name="nomatrik" maxlength="12" required value="<?php echo "$nomatrik"; ?>">
         ...
         <label>Jabatan</label>
		<input type="text"  name="jabatan" maxlength="12" required value="<?php echo "$jabatan"; ?>">
		...
		<input type="number"  name="notel" required value="<?php echo "$notel"; ?>">
