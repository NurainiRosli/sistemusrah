...
<div class="navbar">
  ...
  <a href=""></a>
  <a href=".php">Kehadiran</a>
  <a href="login.php" class="right">Log Keluar</a>
</div>
  
  <div class="main">
	
 <h1>Senarai Kehadiran Pelajar</h1>
    ...
    // Import the file where we defined the connection to Database.     
        ...
        $query = "SELECT * FROM attendance LIMIT $start_from, $per_page_record";    
    ...
    $bil = 1; 
		...
		echo "<td>$time</td>";
		echo "<td>$date</td>";
        echo "<td class='delete'> <a href='attendance_delete.php? siapa=$id'> Padam </a></td>";
        echo "</tr>";
...
?>    
    ...
    echo "</br>";     
        ...
        if($page>=2){   
            echo "<a href='attendance.php?page=".($page-1)."'>  Prev </a>";   
        }       
                   
        for ($i=1; $i<=$total_pages; $i++) {   
          if ($i == $page) {   
              $pagLink .= "<a class = 'active' href='=attendance.php?page="  
                                                .$i."'>".$i." </a>";   
          }               
          else  {   
              $pagLink .= "<a href='=attendance.php?page=".$i."'>   
                                                ".$i." </a>";     
          }   
        };     
        echo $pagLink;   
        ...
        if($page<$total_pages){   
            echo "<a href='=attendance.php?page=".($page+1)."'>  Next </a>";   
        }   
  ...
  <script>   
    ...
    {   
        ...
        window.location.href = '=attendance.php?page='+page;   
    }   
  </script>  
