...
<div><a class="button" href="login.php" >Log Out</a></div>
    <center> 
    <?php  
    ...
    // Import the file where we defined the connection to Database.     
        ...
        $query = "SELECT * FROM program LIMIT $start_from, $per_page_record";    
    ...
    $bil = 1; 
        ...
        echo "<td>$masa</td>";
        echo "<td>$tempat</td>";
        echo "<td class='edit'> <a href='update_program.php? siapa=$id'> Kemaskini</a></td>";
        echo "<td class='delete'> <a href='delete_program.php? siapa=$id'> Padam </a></td>";
        echo "</tr>";
...
?>    
    ...
    echo "</br>";     
        ...
        if($page>=2){   
            echo "<a href='program.php?page=".($page-1)."'>  Prev </a>";   
        }       
                   
        for ($i=1; $i<=$total_pages; $i++) {   
          if ($i == $page) {   
              $pagLink .= "<a class = 'active' href='program.php?page="  
                                                .$i."'>".$i." </a>";   
          }               
          else  {   
              $pagLink .= "<a href='program.php?page=".$i."'>   
                                                ".$i." </a>";     
          }   
        };     
        echo $pagLink;   
        ...
        if($page<$total_pages){   
            echo "<a href='program.php?page=".($page+1)."'>  Next </a>";   
        }   
